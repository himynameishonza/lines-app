        ...
        <View className="flex gap-y-10">
          <View className="flex items-center justify-center gap-y-5">
            <HexagramSymbol
              ...
              changingLines={[
                ...changingLines,
                ...Array(6 - changingLines.length).fill(false),
              ]}
              color="#06283F"
            />
            <View className="flex flex-col items-center justify-between">
              <View className="flex flex-row items-center gap-x-3 mb-3 pt-5">
                <View
                  className={`w-auto px-1 py-0.5 rounded ${getLineBadgeStyle(0).bgClass}`}
                >
                  <GeistMonoText
                    className={`text-xs ${getLineBadgeStyle(0).textClass}`}
                  >
                    {getLineName(0)}
                  </GeistMonoText>
                </View>
                <View
                  className={`w-auto px-1 py-0.5 rounded ${getLineBadgeStyle(1).bgClass}`}
                >
                  <GeistMonoText
                    className={`text-xs ${getLineBadgeStyle(1).textClass}`}
                  >
                    {getLineName(1)}
                  </GeistMonoText>
                </View>
                <View
                  className={`w-auto px-1 py-0.5 rounded ${getLineBadgeStyle(2).bgClass}`}
                >
                  <GeistMonoText
                    className={`text-xs ${getLineBadgeStyle(2).textClass}`}
                  >
                    {getLineName(2)}
                  </GeistMonoText>
                </View>
              ...
              <View className="flex flex-row items-center gap-x-3">
                <View
                  className={`w-auto px-1 py-0.5 rounded ${getLineBadgeStyle(3).bgClass}`}
                >
                  <GeistMonoText
                    className={`text-xs ${getLineBadgeStyle(3).textClass}`}
                  >
                    {getLineName(3)}
                  </GeistMonoText>
                </View>
                <View
                  className={`w-auto px-1 py-0.5 rounded ${getLineBadgeStyle(4).bgClass}`}
                >
                  <GeistMonoText
                    className={`text-xs ${getLineBadgeStyle(4).textClass}`}
                  >
                    {getLineName(4)}
                  </GeistMonoText>
                </View>
                <View
                  className={`w-auto px-1 py-0.5 rounded ${getLineBadgeStyle(5).bgClass}`}
                >
                  <GeistMonoText
                    className={`text-xs ${getLineBadgeStyle(5).textClass}`}
                  >
                    {getLineName(5)}
                  </GeistMonoText>
                </View>
          ...
          <View className="flex flex-row justify-center gap-x-12">
            <View className="flex items-center">
              ...
              <HexagramSymbol
                ...
                lines={
                  lines.length >= 3
                    ? lines.slice(0, 3)
                    : [...lines, ...Array(3 - lines.length).fill(null)]
                }
            ...
            <View className="flex items-center">
              ...
              <HexagramSymbol
                ...
                changingLines={
                  lines.length >= 6 ? changingLines.slice(3, 6) : []
                }
                color="#06283F"
              />
              <GeistMonoText className="pt-2 text-background">
          ...
          {currentLine >= 6 ? (
            ...
            <View className="flex items-center flex-row justify-between px-4">
              <View className="flex flex-col gap-y-2">
                ...
                <GeistMonoText
                  variant="bold"
                  className="text-center text-base text-text/50"
                >
                  {coinValues.length > 0
                    ? coinValues[0] === 2
                      ? t("coinToss.heads")
